					...
					>
						<FormGroup>
							<FormControlLabel control={
								<Checkbox color="primary" checked={this.state.checkedA} onChange={this.handleChange('checkedA')} />
							} label="Option A"
							/>
							<FormControlLabel control={
								...
								<div className="row">
									<div className="col-sm-12 col-md-5">
										<FormControl component="fieldset" required className={classes.formControl}>
											<FormLabel component="legend">Gender Radio</FormLabel>
									...
									<div className="col-sm-12 col-md-7">
										<FormControl component="fieldset" required>
											<FormLabel component="legend">Gender Gender 2</FormLabel>
						...
						<div className="row">
							...
							>
								<FormControl component="fieldset" required error>
									<FormLabel component="legend">Gender cp</FormLabel>

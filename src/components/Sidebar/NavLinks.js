...
export default {
	category1: [
		{
			"menu_title": "sidebar.campaign",
			"menu_icon": "zmdi zmdi-view-dashboard",
			"path": "/campaign",
			"child_routes": null
		},
		{
			"menu_title": "sidebar.offer",
			"menu_icon": "zmdi zmdi-view-compact",
			"path": "/offer",
			"child_routes": null
		},
		{
			"menu_title": "sidebar.lander",
			"menu_icon": "zmdi zmdi-view-web",
			"path": "/lander",
			"child_routes": null
		},
		// {
		// 	"menu_title": "sidebar.camlogo-normalpaign",
		// 	"menu_icon": "zmdi zmdi-view-dashboard",
		// 	"child_routes": [
		// 	   {
		// 		  "path": "/campaign",
		// 		  "menu_title": "sidebar.campaign_table",
		// 		  exact: true
		// 	   },
		// 	   {
		// 		  "path": "/campaign/_log-detail",
		// 		  "menu_title": "sidebar.compaign_stats",
		// 		  exact: true
		// 	   },
		// 	]
		//  },
